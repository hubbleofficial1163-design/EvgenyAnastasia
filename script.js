(function() {
    ...
    function updateTimer() {
        const weddingDate = new Date(2026, 6, 11, 0, 0, 0);
        const now = new Date();
    ...
    function initRSVPForm() {
        const nameInput = document.querySelector('.rsvp-question input[type="text"]');
        const attendanceRadios = document.querySelectorAll('input[name="attendance"]');
        const checkboxes = document.querySelectorAll('.rsvp-checkbox');
        const submitBtn = document.querySelector('.rsvp-button');
